...
pattern_species <- "13LGS_Blackshaw"
...
pattern_num <- 22 #We will have agreed on this number beforehand
target_species <- "Bat"
target_ortho <- "bat" #Again, note the difference from target_species. You may also have to look this one up
target_numname <- "bat" #Again, note the difference from pattern_species. I think this will be consistent
...
target_path <- "/home/kweir6/data_sblacks1/Kurt/Hibernation/Trinity_output/MARCC-produced/Natasha/CoGAPS/"
...
mark <- paste0("Trinity.out.dir.", target_ortho)
h <- match(mark,gho)
...
batty <- numtoname[which(numtoname$species == paste0("Trinity-out-dir-", target_numname)), ]
...
nerfy_t <- t(nerfy)
pdf(paste0("/home/kweir6/data_sblacks1/Kurt/Hibernation/Trinity_output/CoGAPS/ProjectR/", "ProjectR_", pattern_species, "_into_", target_species, ".pdf"))
...
write.table(nerfy_t, file = paste0("/home/kweir6/data_sblacks1/Kurt/Hibernation/Trinity_output/CoGAPS/ProjectR/ProjectR_", pattern_species, "_into_", target_species, ".txt"), quote = FALSE)
